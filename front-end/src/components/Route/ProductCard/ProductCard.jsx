      ...
      <div className="w-full h-[370px] bg-white rounded-lg shadow-sm p-3 relative cursor-pointer">
        ...
        <div className="py-2 flex items-center justify-between">
          <div className="flex">
            ...
            <h4 className={styles.price}>{ data.price ? data.price +  " Ksh " : null}</h4>
          </div>
        ...
        <div>
          ...
          <AiOutlineShoppingCart size={25} className="cursor-pointer absolute right-2 top-24" onClick={() => setOpen(!open)} color="#444" title="Add to cart" />
